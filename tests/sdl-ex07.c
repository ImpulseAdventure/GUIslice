...
bool InitOverlays()
{
  ...
  pElem = microSDL_ElemCreateTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){2,2,320,50},
    "Home Automation",E_FONT_TITLE);
  microSDL_ElemSetTxtCol(pElem,(microSDL_Color){32,32,60});
  microSDL_ElemSetTxtAlign(pElem,MSDL_ALIGN_MID_MID);
  microSDL_ElemSetFillEn(pElem,false);
  pElem = microSDL_ElemCreateTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){0,0,320,50},
    "Home Automation",E_FONT_TITLE);
  microSDL_ElemSetTxtCol(pElem,(microSDL_Color){128,128,240});
  microSDL_ElemSetTxtAlign(pElem,MSDL_ALIGN_MID_MID);
  microSDL_ElemSetFillEn(pElem,false);
  
  // Create background box
  pElem = microSDL_ElemCreateBox(&m_gui,E_ELEM_BOX,E_PG_MAIN,(microSDL_Rect){10,50,300,180});
  microSDL_ElemSetCol(pElem,MSDL_COL_WHITE,MSDL_COL_BLACK,MSDL_COL_BLACK);
  
  // Create dividers
  pElem = microSDL_ElemCreateBox(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){20,100,280,1});
  microSDL_ElemSetCol(pElem,MSDL_COL_GRAY_DK,MSDL_COL_BLACK,MSDL_COL_BLACK);  
  
  pElem = microSDL_ElemCreateBox(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){235,60,1,35});
  microSDL_ElemSetCol(pElem,MSDL_COL_GRAY_DK,MSDL_COL_BLACK,MSDL_COL_BLACK);  
  
  
  // Create color box
  pElem = microSDL_ElemCreateBox(&m_gui,E_ELEM_COLOR,E_PG_MAIN,(microSDL_Rect){20,90+30,130,100});
  microSDL_ElemSetCol(pElem,MSDL_COL_WHITE,MSDL_COL_BLACK,MSDL_COL_BLACK);
  
  // Create Quit button with text label
  pElem = microSDL_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN_QUIT,E_PG_MAIN,
    (microSDL_Rect){250,60,50,30},"SAVE",E_FONT_BTN,&CbBtnQuit);
  microSDL_ElemSetCol(pElem,(microSDL_Color){0,0,192},(microSDL_Color){0,0,128},(microSDL_Color){0,0,224});    
  microSDL_ElemSetTxtCol(pElem,MSDL_COL_WHITE);
  
  // Create dummy selector
  pElem = microSDL_ElemCreateTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){20,65,100,20},
  ...
  pElem = microSDL_ElemCreateBtnTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,
    (microSDL_Rect){140,65,80,20},"Kitchen...",E_FONT_BTN,NULL);
  microSDL_ElemSetCol(pElem,(microSDL_Color){64,64,64},(microSDL_Color){32,32,32},(microSDL_Color){0,0,224});    
  microSDL_ElemSetTxtCol(pElem,MSDL_COL_WHITE);
  ...
  pElem = microSDL_ElemCreateTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){nLabelX,nCtrlY,120,20},
    "Set LED RGB:",E_FONT_HEAD);
  microSDL_ElemSetTxtCol(pElem,MSDL_COL_WHITE);
  nCtrlY += 25;
  
  pElem = microSDL_ElemCreateTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){nLabelX,nCtrlY,nLabelW,nLabelH},
    "Red:",E_FONT_TXT);
  microSDL_ElemSetTxtCol(pElem,MSDL_COL_GRAY_LT);  
  pElem = microSDL_ElemXSliderCreate(&m_gui,E_SLIDER_R,E_PG_MAIN,&m_sXSlider_R,
          (microSDL_Rect){nSlideX,nCtrlY,nSlideW,nSlideH},0,255,255,5,false);
  microSDL_ElemSetCol(pElem,(microSDL_Color){255,0,0},MSDL_COL_BLACK,MSDL_COL_WHITE);          
  microSDL_ElemXSliderSetStyle(pElem,true,(microSDL_Color){128,0,0},10,
  ...
  pElem = microSDL_ElemXSliderCreate(&m_gui,E_SLIDER_G,E_PG_MAIN,&m_sXSlider_G,
          (microSDL_Rect){nSlideX,nCtrlY,nSlideW,nSlideH},0,255,128,5,false);
  microSDL_ElemSetCol(pElem,(microSDL_Color){0,255,0},MSDL_COL_BLACK,MSDL_COL_WHITE);
  microSDL_ElemXSliderSetStyle(pElem,true,(microSDL_Color){0,128,0},10,
          5,(microSDL_Color){64,64,64});
  nCtrlY += nCtrlGap;
  ...
  pElem = microSDL_ElemXSliderCreate(&m_gui,E_SLIDER_B,E_PG_MAIN,&m_sXSlider_B,
          (microSDL_Rect){nSlideX,nCtrlY,nSlideW,nSlideH},0,255,0,5,false);
  microSDL_ElemSetCol(pElem,(microSDL_Color){0,0,255},MSDL_COL_BLACK,MSDL_COL_WHITE);          
  microSDL_ElemXSliderSetStyle(pElem,true,(microSDL_Color){0,0,128},10,
          5,(microSDL_Color){64,64,64});
  nCtrlY += nCtrlGap;

  
  pElem = microSDL_ElemCreateTxt(&m_gui,MSDL_ID_AUTO,E_PG_MAIN,(microSDL_Rect){250,230,60,10},
...
int main( int argc, char* args[] )
{
  ...
  while (!m_bQuit) {
    ...
    microSDL_Color colRGB = (microSDL_Color){nPosR,nPosG,nPosB};
