...
bool InitOverlays()
{
  ...
  static char mstr1[] = "Quit";
  pElem = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN_QUIT,E_PG_MAIN,
    (gslc_tsRect){160,80,80,40},mstr1,strlen(mstr1),E_FONT_BTN,&CbBtnQuit);

  // Create counter
  static char mstr2[] = "Count:";
  pElem = gslc_ElemCreateTxt(&m_gui,GSLC_ID_AUTO,E_PG_MAIN,(gslc_tsRect){20,60,50,10},
    mstr2,strlen(mstr2),E_FONT_TXT);
