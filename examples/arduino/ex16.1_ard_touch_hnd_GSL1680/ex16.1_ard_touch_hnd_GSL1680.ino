// GSL1680 Driver written by Eric Bateman (http://www.github.com/insolace)
// This driver and sketch work with the Eastrising 5" TFT capacitive touchscreen available here:
...
//instantiate the touch handler
  ...
  //SPIClass touchSPI(2);
  TouchHandler_GSL1680 touchHandler = TouchHandler_GSL1680();
#else
