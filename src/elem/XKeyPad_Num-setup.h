...
#define XKEYPAD_COL_BASIC_FILL GSLC_COL_BLUE_LT1
#define XKEYPAD_COL_BASIC_GLOW GSLC_COL_BLUE_LT3
...
#define XKEYPAD_COL_SPACE_FILL GSLC_COL_BLUE_LT1
#define XKEYPAD_COL_SPACE_GLOW GSLC_COL_BLUE_LT3
#define XKEYPAD_COL_ESC_FILL GSLC_COL_RED_LT1
#define XKEYPAD_COL_ESC_GLOW GSLC_COL_RED_LT3
#define XKEYPAD_COL_ENTER_FILL GSLC_COL_GREEN_LT1
#define XKEYPAD_COL_ENTER_GLOW GSLC_COL_GREEN_LT3
#define XKEYPAD_COL_SCROLL_L_FILL GSLC_COL_BLUE_LT1
#define XKEYPAD_COL_SCROLL_L_GLOW GSLC_COL_BLUE_LT3
#define XKEYPAD_COL_SCROLL_R_FILL GSLC_COL_BLUE_LT1
...
#define XKEYPAD_COL_DECIMAL_GLOW GSLC_COL_GRAY_LT3
#define XKEYPAD_COL_MINUS_FILL GSLC_COL_GRAY_DK1
#define XKEYPAD_COL_MINUS_GLOW GSLC_COL_GRAY_LT3
